...
* variables and data types, input and output, arithmetic or logical expressions, conditionals, loops, strings, lists, tuples, dictionaries, functions, readable code structure, comments, and simple header documentation
...
* a breakdown of the program into different parts (main parts, functions, features).
